...
if [ ! -f $PROSA_DIR/src/ch01-03-puppet.md ]; then curl -H 'Content-type:text/html' https://raw.githubusercontent.com/worldline/Puppet-ProSA/refs/heads/main/README.md -o $PROSA_DIR/src/ch01-03-puppet.md; fi
